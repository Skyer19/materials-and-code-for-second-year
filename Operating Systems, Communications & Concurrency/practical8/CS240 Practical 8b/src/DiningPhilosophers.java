...
class Philosopher extends Thread {
	...
	//
	public Philosopher(int myName, int[] chopSticks) {
...
//			System.out.println(haveChopSticks);
			while(!haveChopSticks) {
				mutex.acquire();
//				System.out.println(mutex);
				if ((chopSticks[myName]==1) && (chopSticks[(myName+1)%5]==1)) {
					chopSticks[myName]=0; chopSticks[(myName+1)%5]=0; haveChopSticks = true;
					}
