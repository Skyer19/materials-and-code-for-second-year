...
namespace Pong
{
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (IsKeyPushedDown(Keys.S)) Paddle_Left_Y += 10;
            if (IsKeyPushedDown(Keys.I)) Paddle_Right_Y -= 10;
            ...
            g.FillEllipse(new SolidBrush(Color.Green), Ball.X - 10, Ball.Y - 10, 20, 20);
